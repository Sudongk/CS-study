...
- 대표적으로 **캐싱**을 할 때 많이 사용되며, key-value store라고 불리는 NoSQL(Redis, etcd 등)이다.
...
![](/Java/img/java_hashmap_4.png)

<br>

### 2) Separate chaining (분리 연결법)

![](/Java/img/java_hashmap_5.png)
